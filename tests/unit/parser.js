...
exports["generator unused export"] = function (test) {
...
exports["asyncawait basics"] = function (test) {
...
exports["asyncawait within classes"] = function (test) {
  var options = { esnext: true, experimental: ["asyncawait"] };
...
exports["asyncawait errors"] = function (test) {
...
exports["async await keywords allowed when disabled"] = function (test) {
